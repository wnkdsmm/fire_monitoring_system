...
def _build_cumulative_area_chart(*args, **kwargs):
    _sync_engine()
    return _impact_fire_metrics_mod._build_cumulative_area_chart(*args, **kwargs)


def _build_monthly_heatmap_chart(*args, **kwargs):
    _sync_engine()
    return _impact_fire_metrics_mod._build_monthly_heatmap_chart(*args, **kwargs)
...
class DashboardImpactMetrics:
    ...
    build_cumulative_area_chart = staticmethod(_build_cumulative_area_chart)
    build_monthly_heatmap_chart = staticmethod(_build_monthly_heatmap_chart)
