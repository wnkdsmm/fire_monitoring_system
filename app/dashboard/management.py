            ...
            actions.append(
                {
                    ...
                    "detail": f"Р’ С‚РµРєСѓС‰РµРј СЃСЂРµР·Рµ С‡Р°С‰Рµ РІСЃРµРіРѕ С„РёРєСЃРёСЂСѓРµС‚СЃСЏ РїСЂРёС‡РёРЅР° Р’В«{dominant_cause['label']}Р’В» ({dominant_cause['value_display']}).",
                }
            )
        if top_district:
            actions.append(
            ...
            actions.append(
                {
                    ...
                    "detail": f"{trend.get('description') or 'Р”РёРЅР°РјРёРєР° С‚СЂРµР±СѓРµС‚ СѓС‚РѕС‡РЅРµРЅРёСЏ.'} Р ВР В·Р СР ВµР Р…Р ВµР Р…Р С‘Р Вµ: {trend.get('delta_display') or '0'}.",
                }
            )
