...
def _build_dashboard_payload(
    *,
    ...
    if not PLOTLY_AVAILABLE:
        notes.append("Р‘РёР±Р»РёРѕС‚РµРєР° Plotly РЅРµ РЅР°Р№РґРµРЅР° РІ РѕРєСЂСѓР¶РµРЅРёРё. Р ВР Р…РЎвЂљР ВµРЎР‚Р В°Р С”РЎвЂљР С‘Р Р†Р Р…РЎвЂ№Р Вµ РіСЂР°С„РёРєРё РЅРµ Р±СѓРґСѓС‚ РїРѕРєР°Р·Р°РЅС‹.")
