...
MANDATORY_FEATURE_REGISTRY = [
    ...
    },
    {
        "id": "children",
        "label": "Дети",
        "description": "Дети, эвакуированные дети и спасенные дети для оценки последствий пожара и социальной нагрузки.",
        "synonyms": [
            "Дети",
            "Количество детей",
            "Число детей",
            "Кол-во детей",
            "Количество детей в КУП",
            "Число детей в КУП",
            "Эвакуировано детей",
            "Количество эвакуированных детей",
            "Число эвакуированных детей",
            "Спасено детей",
            "Количество спасенных детей",
            "Число спасенных детей",
        ],
        "token_sets": [["дет"], ["ребен"], ["эваку", "дет"], ["спас", "дет"]],
        "exclude_tokens": ["дата", "время", "фио", "сотрудник"],
    },
    {
        "id": "damage",
        "label": "Ущерб",
