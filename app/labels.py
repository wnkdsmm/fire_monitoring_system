...
SCENARIO_FORECAST_DESCRIPTION = (
    ...
    "Это не временной анализ ожидаемого числа пожаров: экран отвечает на вопрос «когда готовиться», а не «сколько пожаров может быть по датам»."
)
...
FORECASTING_NOTE_INTERPRETATION = (
    ...
    "а не как точное обещание числа пожаров. Если нужен прогноз количества, используйте временной анализ пожаров."
)
...
ML_MODEL_NAME = "Временной анализ и прогноз пожаров"
...
ML_PREDICTIVE_BLOCK_DESCRIPTION = (
    "Раздел открывают, когда нужно оценить ожидаемое число пожаров по датам для выбранного среза. "
