...
def get_access_points_shell_context(
    *,
    ...
    initial_data = _empty_access_points_data(
        ...
        summary=summary,
        notes=[
            "РћС‚РєСЂС‹С‚ РѕР±Р»РµРіС‡С‘РЅРЅС‹Р№ shell-СЂРµР¶РёРј СЃС‚СЂР°РЅРёС†С‹. РџРѕР»РЅС‹Р№ ranking РїСЂРѕР±Р»РµРјРЅС‹С… С‚РѕС‡РµРє РґРѕРіСЂСѓР¶Р°РµС‚СЃСЏ РѕС‚РґРµР»СЊРЅС‹Рј Р·Р°РїСЂРѕСЃРѕРј.",
        ],
    ...
    initial_data["loading_status_message"] = "РЎРѕР±РёСЂР°РµРј РёРЅС†РёРґРµРЅС‚С‹ РїРѕ С‚РѕС‡РєР°Рј, СЃС‡РёС‚Р°РµРј score РґРѕСЃС‚СѓРїРЅРѕСЃС‚Рё Рё РїРѕСЏСЃРЅРµРЅРёСЏ."
    return {
        "generated_at": _format_datetime(datetime.now()),
...
def get_access_points_data(
    *,
    ...
    payload = {
        ...
        "model_description": (
            "Р РµР№С‚РёРЅРі СЃС‚СЂРѕРёС‚СЃСЏ РїРѕ РѕС‚РґРµР»СЊРЅС‹Рј С‚РѕС‡РєР°Рј, Р° РЅРµ РїРѕ РєР»Р°СЃС‚РµСЂР°Рј С‚РµСЂСЂРёС‚РѕСЂРёР№: СЃРЅР°С‡Р°Р»Р° Р°РґСЂРµСЃ/РѕР±СЉРµРєС‚, Р·Р°С‚РµРј РєРѕРѕСЂРґРёРЅР°С‚РЅР°СЏ С‚РѕС‡РєР°,"
            " РґР°Р»РµРµ РЅР°СЃРµР»С‘РЅРЅС‹Р№ РїСѓРЅРєС‚ РёР»Рё territory label. Итоговый score РєРѕРјР±РёРЅРёСЂСѓРµС‚ РґРѕСЃС‚СѓРїРЅРѕСЃС‚СЊ РџР§, РІСЂРµРјСЏ РїСЂРёР±С‹С‚РёСЏ,"
