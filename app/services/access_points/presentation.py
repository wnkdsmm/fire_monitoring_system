...
def _build_filter_description(selected_table_label: str, selected_district_label: str, selected_year_label: str) -> str:
    ...
    if selected_year_label and selected_year_label != "Р вЂ™РЎРѓР Вµ Р С–Р С•Р Т‘РЎвЂ№":
        parts.append(f"Р С–Р С•Р Т‘: {selected_year_label}")
    return " | ".join(parts)
...
def _build_notes(
    ...
    if rows:
        notes.append(
            "Score 0-100 РЎРѓРЎвЂљРЎР‚Р С•Р С‘РЎвЂљРЎРѓРЎРЏ Р С”Р В°Р С” explainable model: Р Р†Р С”Р В»Р В°Р Т‘ Р С”Р В°Р В¶Р Т‘Р С•Р С–Р С• РЎвЂћР В°Р С”РЎвЂљР С•РЎР‚Р В° Р Р†Р С‘Р Т‘Р ВµР Р… Р С•РЎвЂљР Т‘Р ВµР В»РЎРЉР Р…Р С•, Р В° Р Р…Р ВµР С—Р С•Р В»Р Р…Р С•РЎвЂљР В° Р Т‘Р В°Р Р…Р Р…РЎвЂ№РЎвЂ¦ Р Т‘Р В°РЎвЂРЎвЂљ Р С•Р С–РЎР‚Р В°Р Р…Р С‘РЎвЂЎР ВµР Р…Р Р…РЎвЂ№Р в„– penalty Р С‘ Р Р…Р Вµ Р Т‘Р С•Р В»Р В¶Р Р…Р В° Р Т‘Р С•Р СР С‘Р Р…Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ Р Р…Р В°Р Т‘ РЎР‚Р ВµР В°Р В»РЎРЉР Р…РЎвЂ№Р С РЎР‚Р С‘РЎРѓР С”Р С•Р С."
        )
        ...
        if incomplete_points:
            notes.append(
                "Р вЂР В»Р С•Р С” Р’В«Р вЂќР В°Р Р…Р Р…РЎвЂ№Р Вµ Р Р…Р ВµР С—Р С•Р В»Р Р…РЎвЂ№Р ВµР’В» Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р ВµРЎвЂљ РЎвЂљР С•РЎвЂЎР С”Р С‘, Р С–Р Т‘Р Вµ Р Р…РЎС“Р В¶Р Р…РЎвЂ№ РЎС“РЎвЂљР С•РЎвЂЎР Р…Р ВµР Р…Р С‘РЎРЏ Р С—Р С• Р Р†Р С•Р Т‘Р Вµ, Р Р†РЎР‚Р ВµР СР ВµР Р…Р С‘ Р С—РЎР‚Р С‘Р В±РЎвЂ№РЎвЂљР С‘РЎРЏ Р С‘Р В»Р С‘ Р Т‘Р С‘РЎРѓРЎвЂљР В°Р Р…РЎвЂ Р С‘Р С‘ Р Т‘Р С• Р СџР В§, Р С—РЎР‚Р ВµР В¶Р Т‘Р Вµ РЎвЂЎР ВµР С Р С—РЎР‚Р С‘Р Р…Р С‘Р СР В°РЎвЂљРЎРЉ Р В¶РЎвЂРЎРѓРЎвЂљР С”Р С‘Р Вµ РЎС“Р С—РЎР‚Р В°Р Р†Р В»Р ВµР Р…РЎвЂЎР ВµРЎРѓР С”Р С‘Р Вµ Р СР ВµРЎР‚РЎвЂ№."
            )
