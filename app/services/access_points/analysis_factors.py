...
from config.constants import (
    ACCESS_POINT_CODE_DISTANCE,
    ACCESS_POINT_CODE_HEATING,
    ACCESS_POINT_CODE_LONG_ARRIVAL,
    ACCESS_POINT_CODE_NIGHT,
    ACCESS_POINT_CODE_RECURRENCE,
    ACCESS_POINT_CODE_RESPONSE,
    ACCESS_POINT_CODE_SEVERITY,
    ACCESS_POINT_CODE_WATER,
    ACCESS_POINT_CRITICAL_THRESHOLD,
    ACCESS_POINT_FACTOR_WEIGHTS,
    ACCESS_POINT_HIGH_THRESHOLD,
    ACCESS_POINT_MEDIUM_THRESHOLD,
    ...
    ACCESS_POINT_UNCERTAINTY_PENALTY_MAX,
...
DISTANCE_CODE = ACCESS_POINT_CODE_DISTANCE
RESPONSE_CODE = ACCESS_POINT_CODE_RESPONSE
LONG_ARRIVAL_CODE = ACCESS_POINT_CODE_LONG_ARRIVAL
WATER_CODE = ACCESS_POINT_CODE_WATER
SEVERITY_CODE = ACCESS_POINT_CODE_SEVERITY
RECURRENCE_CODE = ACCESS_POINT_CODE_RECURRENCE
NIGHT_CODE = ACCESS_POINT_CODE_NIGHT
HEATING_CODE = ACCESS_POINT_CODE_HEATING
UNCERTAINTY_CODE = "DATA_UNCERTAINTY"

FACTOR_WEIGHTS = ACCESS_POINT_FACTOR_WEIGHTS
SEVERITY_SEVERE_WEIGHT = ACCESS_POINT_SEVERITY_SEVERE_WEIGHT
SEVERITY_VICTIM_WEIGHT = ACCESS_POINT_SEVERITY_VICTIM_WEIGHT
SEVERITY_DAMAGE_WEIGHT = ACCESS_POINT_SEVERITY_DAMAGE_WEIGHT
RECURRENCE_FREQUENCY_WEIGHT = ACCESS_POINT_RECURRENCE_FREQUENCY_WEIGHT
RECURRENCE_INCIDENTS_WEIGHT = ACCESS_POINT_RECURRENCE_INCIDENTS_WEIGHT
UNCERTAINTY_ARRIVAL_WEIGHT = ACCESS_POINT_UNCERTAINTY_ARRIVAL_WEIGHT
UNCERTAINTY_WATER_WEIGHT = ACCESS_POINT_UNCERTAINTY_WATER_WEIGHT
UNCERTAINTY_DISTANCE_WEIGHT = ACCESS_POINT_UNCERTAINTY_DISTANCE_WEIGHT
UNCERTAINTY_SUPPORT_WEIGHT = ACCESS_POINT_UNCERTAINTY_SUPPORT_WEIGHT
...
UNCERTAINTY_PENALTY_MAX = ACCESS_POINT_UNCERTAINTY_PENALTY_MAX
CRITICAL_THRESHOLD = ACCESS_POINT_CRITICAL_THRESHOLD
HIGH_THRESHOLD = ACCESS_POINT_HIGH_THRESHOLD
MEDIUM_THRESHOLD = ACCESS_POINT_MEDIUM_THRESHOLD
...
def _build_access_point_factor_series(base: _AccessPointBaseSeries) -> _AccessPointFactorSeries:
    ...
    distance_scale = max(SERVICE_DISTANCE_TARGET_KM, _finite_series_max(base.average_distance, 0.0))
    response_scale = max(
