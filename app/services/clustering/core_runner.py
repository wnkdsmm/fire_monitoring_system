...
def _build_clustering_model_stage_context(
    *,
    ...
    prepared_model_inputs = _prepare_model_inputs(
        cluster_frame,
        entity_frame,
    ...
    if hopkins is not None and hopkins < HOPKINS_MIN_CLUSTERABLE:
        base["notes"].append(
            f"РЎС‚СЂСѓРєС‚СѓСЂР° РєР»Р°СЃС‚РµСЂРѕРІ РІС‹СЂР°Р¶РµРЅР° СЃР»Р°Р±Рѕ (СЃС‚Р°С‚РёСЃС‚РёРєР° РҐРѕРїРєРёРЅСЃР° = {hopkins:.2f}): СЃРµРіРјРµРЅС‚Р°С†РёСЏ РјРѕР¶РµС‚ Р±С‹С‚СЊ РјРµРЅРµРµ РєРѕРЅС‚СЂР°СЃС‚РЅРѕР№, РЅРѕ РѕСЃС‚Р°С‘С‚СЃСЏ РїРѕР»РµР·РЅРѕР№ РґР»СЏ РѕСЂРёРµРЅС‚РёСЂРѕРІРѕС‡РЅРѕРіРѕ Р°РЅР°Р»РёР·Р°."
        )
