...
def _build_notes(
    ...
    if total_entities > sampled_entities:
        ...
        if sampling_strategy == "stratified":
            sampling_note = (
                f"Р”Рѕ РєР»Р°СЃС‚РµСЂРёР·Р°С†РёРё Р±С‹Р»Рё СЃРѕР±СЂР°РЅС‹ Р°РіСЂРµРіР°С‚С‹ РїРѕ { _format_integer(total_entities) } С‚РµСЂСЂРёС‚РѕСЂРёСЏРј, "
                "Р° Р·Р°С‚РµРј РѕС‚РѕР±СЂР°РЅР° РїРѕРґРІС‹Р±РѕСЂРєР° СЃ РїСЂРѕРїРѕСЂС†РёРѕРЅР°Р»СЊРЅРѕР№ СЃС‚СЂР°С‚РёС„РёРєР°С†РёРµР№."
            )
        elif sampling_strategy == "random":
            sampling_note = (
                f"Р”Рѕ РєР»Р°СЃС‚РµСЂРёР·Р°С†РёРё Р±С‹Р»Рё СЃРѕР±СЂР°РЅС‹ Р°РіСЂРµРіР°С‚С‹ РїРѕ { _format_integer(total_entities) } С‚РµСЂСЂРёС‚РѕСЂРёСЏРј, "
                "Р° Р·Р°С‚РµРј РѕС‚РѕР±СЂР°РЅР° СЂР°РІРЅРѕРјРµСЂРЅР°СЏ СЃР»СѓС‡Р°Р№РЅР°СЏ РїРѕРґРІС‹Р±РѕСЂРєР°."
            )
        elif sampling_strategy == "systematic":
            sampling_note = (
                f"Р”Рѕ РєР»Р°СЃС‚РµСЂРёР·Р°С†РёРё Р±С‹Р»Рё СЃРѕР±СЂР°РЅС‹ Р°РіСЂРµРіР°С‚С‹ РїРѕ { _format_integer(total_entities) } С‚РµСЂСЂРёС‚РѕСЂРёСЏРј, "
                "Р° Р·Р°С‚РµРј РІС‹РїРѕР»РЅРµРЅ СЃРёСЃС‚РµРјР°С‚РёС‡РµСЃРєРёР№ РѕС‚Р±РѕСЂ РїРѕРґРІС‹Р±РѕСЂРєРё."
            )
        else:
            sampling_note = (
                f"Р”Рѕ РєР»Р°СЃС‚РµСЂРёР·Р°С†РёРё Р±С‹Р»Рё СЃРѕР±СЂР°РЅС‹ Р°РіСЂРµРіР°С‚С‹ РїРѕ { _format_integer(total_entities) } С‚РµСЂСЂРёС‚РѕСЂРёСЏРј, "
                "Р° Р·Р°С‚РµРј РѕС‚РѕР±СЂР°РЅР° РїРѕРґРІС‹Р±РѕСЂРєР°."
            )
...
def _build_k_selection_note(
    ...
    if best_quality_k and best_silhouette_k and best_quality_k != best_silhouette_k:
        return (
            f"Р’ РґРѕСЃС‚СѓРїРЅРѕРј РґРёР°РїР°Р·РѕРЅРµ k={available_k_label} РїРѕ СЃРѕРІРѕРєСѓРїРЅРѕСЃС‚Рё РїРѕРєР°Р·Р°С‚РµР»РµР№ Рё СЂР°Р·РјРµСЂРѕРІ РіСЂСѓРїРї Р»СѓС‡С€Рµ РІС‹РіР»СЏРґРёС‚ k={best_quality_k}, "
            f"С…РѕС‚СЏ РїРѕ С‡С‘С‚РєРѕСЃС‚Рё РіСЂР°РЅРёС† РѕС‚РґРµР»СЊРЅРѕ Р»РёРґРёСЂСѓРµС‚ k={best_silhouette_k}."
        )
    if best_quality_k:
        return f"Р’ РґРѕСЃС‚СѓРїРЅРѕРј РґРёР°РїР°Р·РѕРЅРµ k={available_k_label} РїРѕ СЃРѕРІРѕРєСѓРїРЅРѕСЃС‚Рё РїРѕРєР°Р·Р°С‚РµР»РµР№ Рё СЂР°Р·РјРµСЂРѕРІ РіСЂСѓРїРї РЅР°РёР±РѕР»РµРµ СѓР±РµРґРёС‚РµР»СЊРЅРѕ РІС‹РіР»СЏРґРёС‚ k={best_quality_k}."
    if best_silhouette_k and elbow_k and best_silhouette_k != elbow_k:
        return (
            f"Р’ РґРѕСЃС‚СѓРїРЅРѕРј РґРёР°РїР°Р·РѕРЅРµ k={available_k_label} РїРѕ С‡С‘С‚РєРѕСЃС‚Рё РіСЂР°РЅРёС† Р»СѓС‡С€РёР№ СЂРµР·СѓР»СЊС‚Р°С‚ РґР°С‘С‚ k={best_silhouette_k}, "
            f"Р° Р·Р°РјРµС‚РЅС‹Р№ РїРµСЂРµР»РѕРј РєСЂРёРІРѕР№ РЅР°С‡РёРЅР°РµС‚СЃСЏ РѕРєРѕР»Рѕ k={elbow_k}."
        )
    if best_silhouette_k:
        return f"Р’ РґРѕСЃС‚СѓРїРЅРѕРј РґРёР°РїР°Р·РѕРЅРµ k={available_k_label} РїРѕ С‡С‘С‚РєРѕСЃС‚Рё РіСЂР°РЅРёС† Р»СѓС‡С€РёР№ СЂРµР·СѓР»СЊС‚Р°С‚ РґР°С‘С‚ k={best_silhouette_k}."
    if elbow_k:
        return f"Р’ РґРѕСЃС‚СѓРїРЅРѕРј РґРёР°РїР°Р·РѕРЅРµ k={available_k_label} РєСЂРёРІР°СЏ РІРЅСѓС‚СЂРёРіСЂСѓРїРїРѕРІРѕРіРѕ СЂР°Р·Р±СЂРѕСЃР° Р·Р°РјРµС‚РЅРѕ РјРµРЅСЏРµС‚СЃСЏ РѕРєРѕР»Рѕ k={elbow_k}."
    return None
