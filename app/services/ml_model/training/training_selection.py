...
def _build_count_selection_details(
    ...
    if baseline_delta is not None:
        long_reason += f' Р ВР В·Р СР ВµР Р…Р ВµР Р…Р С‘Р Вµ MAE РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅРѕ seasonal baseline СЃРѕСЃС‚Р°РІРёР»Рѕ {baseline_delta * 100.0:+.1f}%.'
    ...
    if heuristic_improvement is not None and selected_count_model_key != 'heuristic_forecast':
        long_reason += f' Р ВР В·Р СР ВµР Р…Р ВµР Р…Р С‘Р Вµ MAE РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅРѕ heuristic forecast СЃРѕСЃС‚Р°РІРёР»Рѕ {heuristic_improvement * 100.0:+.1f}%.'
    ...
    for model_key in COUNT_MODEL_KEYS:
        ...
        rows.append(
            CountComparisonRow(
                ...
                role_label='Р ВР Р…РЎвЂљР ВµРЎР‚Р С—РЎР‚Р ВµРЎвЂљР С‘РЎР‚РЎС“Р ВµР СР В°РЎРЏ count-РјРѕРґРµР»СЊ',
