...
def _build_notes(
    ...
    if not ml_result.get('is_ready') and filtered_records_count > 0:
        append_note('Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РїРѕРєР° РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ, С‡С‚РѕР±С‹ РїРѕРєР°Р·Р°С‚СЊ СѓСЃС‚РѕР№С‡РёРІС‹Р№ ML-РїСЂРѕРіРЅРѕР· Рё РїСЂРѕРІРµСЂРєСѓ РєР°С‡РµСЃС‚РІР°.')
    if len(daily_history) < 60:
        append_note('Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РјРµРЅСЊС€Рµ 60 РґРЅРµР№: РґР»СЏ РєРѕСЂСЂРµРєС‚РЅРѕР№ ML-РІР°Р»РёРґР°С†РёРё СЌС‚РѕРіРѕ РѕР±С‹С‡РЅРѕ РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ.')
