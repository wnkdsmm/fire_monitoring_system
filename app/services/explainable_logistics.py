...
from config.constants import (
    ...
    COVERAGE_FALLBACK_RURAL,
    COVERAGE_FALLBACK_URBAN,
    ...
    DISTANCE_COVERAGE_HIGH_MULTIPLIER,
    DISTANCE_COVERAGE_LOW_MULTIPLIER,
...
def build_explainable_logistics_profile(
    *,
    ...
    distance_pressure = _clamp(((safe_distance or DEFAULT_DISTANCE_KM_BASELINE) - DISTANCE_SCORE_MIN_KM) / DISTANCE_SCORE_RANGE_KM, 0.0, 1.0)
    response_pressure = (
        ...
        else _clamp(max(RESPONSE_PRESSURE_UNKNOWN_FALLBACK, distance_pressure * RESPONSE_PRESSURE_DISTANCE_SCALE), 0.0, 1.0)
    )
