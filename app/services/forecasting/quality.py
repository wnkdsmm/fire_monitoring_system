...
def _build_scenario_quality_assessment(backtest: dict[str, Any]) -> dict[str, Any]:
    ...
    mae_delta_display = (
        _format_signed_percent(model_metrics.get("mae_delta_vs_baseline"))
        if model_metrics.get("mae_delta_vs_baseline") is not None
        else "\u2014"
    )
    comparison_rows = [
        {
        ...
        },
        {
            ...
            "mae_delta_display": mae_delta_display,
        },
    ]
    return {
        "ready": True,
        ...
        "metric_cards": [
            ...
            {"label": "MAE \u043a \u0431\u0430\u0437\u043e\u0432\u043e\u0439 \u043c\u043e\u0434\u0435\u043b\u0438", "value": mae_delta_display, "meta": "\u043e\u0442\u0440\u0438\u0446\u0430\u0442\u0435\u043b\u044c\u043d\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u043b\u0443\u0447\u0448\u0435 \u0431\u0430\u0437\u043e\u0432\u043e\u0439 \u043c\u043e\u0434\u0435\u043b\u0438"},
        ],
        "methodology_items": [
        ...
        "dissertation_points": [
            ...
            f"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 MAE \u043e\u0442\u043d\u043e\u0441\u0438\u0442\u0435\u043b\u044c\u043d\u043e \u0431\u0430\u0437\u043e\u0432\u043e\u0439 \u043c\u043e\u0434\u0435\u043b\u0438 \u0441\u043e\u0441\u0442\u0430\u0432\u0438\u043b\u043e {mae_delta_display}, \u0447\u0442\u043e \u043f\u043e\u0437\u0432\u043e\u043b\u044f\u0435\u0442 \u043a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u0435\u043d\u043d\u043e \u0441\u0440\u0430\u0432\u043d\u0438\u0432\u0430\u0442\u044c \u0441\u0446\u0435\u043d\u0430\u0440\u043d\u044b\u0439 \u0431\u043b\u043e\u043a \u0441 \u043e\u043f\u043e\u0440\u043d\u043e\u0439 \u0441\u0435\u0437\u043e\u043d\u043d\u043e\u0439 \u043c\u043e\u0434\u0435\u043b\u044c\u044e.",
        ],
    }
