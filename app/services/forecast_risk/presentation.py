...
def _build_feature_cards(metadata_items: Sequence[dict[str, Any]]) -> list[FeatureCard]:
    ...
    feature_config = [
        ...
        },
        {
            ...
            "description": "Р ВРЎРѓР С—Р С•Р В»РЎРЉР В·РЎС“Р ВµРЎвЂљРЎРѓРЎРЏ РґР»СЏ РѕС†РµРЅРєРё Р»РѕРіРёСЃС‚РёС‡РµСЃРєРѕРіРѕ СЂРёСЃРєР°.",
        ...
        {
            "label": "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎРЏ РїРѕР¶Р°СЂРѕРІ",
        ...
        },
        {
            ...
            "description": "Р ВРЎРѓР С—Р С•Р В»РЎРЉР В·РЎС“РЎР‹РЎвЂљРЎРѓРЎРЏ РїРѕСЃР»РµРґСЃС‚РІРёСЏ, СѓС‰РµСЂР± Рё РїРѕСЃС‚СЂР°РґР°РІС€РёРµ РґР»СЏ РѕС†РµРЅРєРё С‚СЏР¶РµСЃС‚Рё СЃС†РµРЅР°СЂРёСЏ.",
            "resolved_keys": [
                "consequence",
                "registered_damage",
                "destroyed_buildings",
    ...
    for feature in feature_config:
        ...
        if full_tables == total_tables and total_tables > 0:
            status, status_label = ("used", "Р ВРЎРѓР С—Р С•Р В»РЎРЉР В·РЎС“Р ВµРЎвЂљРЎРѓРЎРЏ")
...
def _build_quality_passport(
    ...
    critical_labels = {
        ...
        "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎРЏ РїРѕР¶Р°СЂРѕРІ",
