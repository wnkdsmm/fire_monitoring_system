...
def _build_feature_cards(metadata_items: Sequence[dict[str, Any]]) -> list[FeatureCard]:
    ...
    feature_config = [
        ...
        },
        {
            ...
            "description": "РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ для оценки логистического риска.",
        ...
        },
        {
            ...
            "description": "РСЃРїРѕР»СЊР·СѓСЋС‚СЃСЏ последствия, ущерб и пострадавшие для оценки тяжести сценария.",
            "resolved_keys": [
                "consequence",
                "registered_damage",
                "destroyed_buildings",
