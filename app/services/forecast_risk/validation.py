...
def build_historical_validation_payload(
    ...
    if not windows_bundle.get("is_ready"):
        payload["summary"] = windows_bundle.get("reason") or "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РїРѕРєР° РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ РґР»СЏ РїСЂРѕРІРµСЂРєРё СЂР°РЅР¶РёСЂРѕРІР°РЅРёСЏ РЅР° РёСЃС‚РѕСЂРёС‡РµСЃРєРёС… РѕРєРЅР°С…."
...
def empty_historical_validation_payload(mode_label: str = "РђРґР°РїС‚РёРІРЅС‹Рµ РІРµСЃР°") -> HistoricalValidationPayload:
    return {
        "title": "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎвЂЎР ВµРЎРѓР С”Р В°РЎРЏ РїСЂРѕРІРµСЂРєР° ranking-РєР°С‡РµСЃС‚РІР°",
...
def _build_historical_windows(
    ...
    if history_days < min_training_days + horizon_days:
        return {
            "is_ready": False,
            "reason": (
                "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РїРѕРєР° РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ РґР»СЏ РїСЂРѕРІРµСЂРєРё ranking-Р±Р»РѕРєР° РЅР° РёСЃС‚РѕСЂРёС‡РµСЃРєРёС… РѕРєРЅР°С…. "
...
def _validation_status(aggregate: ValidationMetricsRaw) -> tuple[str, str]:
    ...
    if windows_count >= 4 and topk_capture >= 0.60 and ndcg >= 0.62:
        return "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎвЂЎР ВµРЎРѓР С”Р С‘Р в„– СЃРёРіРЅР°Р» СѓСЃС‚РѕР№С‡РёРІ", "forest"
    if windows_count >= 3 and topk_capture >= 0.45 and ndcg >= 0.48:
        return "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎвЂЎР ВµРЎРѓР С”Р С‘Р в„– СЃРёРіРЅР°Р» СЂР°Р±РѕС‡РёР№", "sky"
