...
def _build_risk_notes(
    ...
    notes.append("РС‚РѕРіРѕРІС‹Р№ риск всегда раскладывается на четыре компонента: частоту пожаров, тяжесть последствий, долгое прибытие и дефицит водоснабжения.")
    ...
    notes.append(
        f"РСЃС‚РѕСЂРёС‡РµСЃРєР°СЏ проверка ранжирования: {historical_validation.get('status_label') or 'пока без проверки'}. "
