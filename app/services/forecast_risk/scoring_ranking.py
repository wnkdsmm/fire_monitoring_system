        ...
        item.update(
            {
                ...
                "ranking_position_display": f"РїС—Р…{index + 1}",
...
def _top_territory_lead(top_territory: dict[str, Any] | None) -> str:
    ...
    parts = [
        f"{top_territory['action_label']}. Р ВРЎвЂљР С•Р С–Р С•Р Р†РЎвЂ№Р в„– СЂРёСЃРє {top_territory['risk_display']} С„РѕСЂРјРёСЂСѓСЋС‚ РїСЂРµР¶РґРµ РІСЃРµРіРѕ {strongest_components}.",
