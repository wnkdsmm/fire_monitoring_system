    ...
    if not windows_bundle.get("is_ready") or len(windows_bundle.get("windows") or []) < MIN_CALIBRATION_WINDOWS:
        return _build_expert_fallback_profile(
            ...
            reason=(
                ...
                or "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РїРѕРєР° РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ РґР»СЏ СѓСЃС‚РѕР№С‡РёРІРѕР№ РєР°Р»РёР±СЂРѕРІРєРё РІРµСЃРѕРІ РїРѕ РёСЃС‚РѕСЂРёС‡РµСЃРєРёРј РѕРєРЅР°Рј."
            ),
        )
...
def _build_expert_fallback_profile(
    ...
    profile["description"] = (
        "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘ РїРѕРєР° РЅРµРґРѕСЃС‚Р°С‚РѕС‡РЅРѕ РґР»СЏ СѓСЃС‚РѕР№С‡РёРІРѕР№ РєР°Р»РёР±СЂРѕРІРєРё РІРµСЃРѕРІ, РїРѕСЌС‚РѕРјСѓ СЃРµСЂРІРёСЃ РёСЃРїРѕР»СЊР·СѓРµС‚ СЌРєСЃРїРµСЂС‚РЅС‹Р№ РїСЂРѕС„РёР»СЊ РєР°Рє СЂРµР·РµСЂРІРЅС‹Р№ СЂРµР¶РёРј."
    )
    summary = (
    ...
    calibration.update(
        {
            ...
            "notes": _unique_non_empty(
                ...
                + [reason, "Р ВРЎРѓР С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°Р Р…РЎвЂ№ СЌРєСЃРїРµСЂС‚РЅС‹Рµ РІРµСЃР° РєР°Рє fallback."]
            ),
        }
    )
    profile["notes"] = notes
...
def _build_expert_retained_profile(
    ...
    summary = (
        "Р ВРЎРѓРЎвЂљР С•РЎР‚Р С‘РЎвЂЎР ВµРЎРѓР С”Р С‘Р Вµ РѕРєРЅР° РїСЂРѕРІРµСЂРµРЅС‹, РЅРѕ Р°Р»СЊС‚РµСЂРЅР°С‚РёРІРЅС‹Рµ РІРµСЃР° РЅРµ РїРѕРєР°Р·Р°Р»Рё СѓСЃС‚РѕР№С‡РёРІРѕРіРѕ РІС‹РёРіСЂС‹С€Р° РїРѕ ranking-РјРµС‚СЂРёРєР°Рј. "
