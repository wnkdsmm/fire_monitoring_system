(function (global) {
    ...
    function renderCompareChart(compareSeries, chartId, fallbackId, summaryId) {
        ...
        if (summaryNode) {
            ...
            summaryNode.textContent = aYear + ': факт ' + String(aSummary.fact_days || 0) + ', ML ' + String(aSummary.ml_days || 0)
                + ' | ' + bYear + ': факт ' + String(bSummary.fact_days || 0) + ', ML ' + String(bSummary.ml_days || 0);
        }
    }
