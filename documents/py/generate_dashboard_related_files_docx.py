...
OUTPUT_PATH = ROOT / "documents" / "dashboard_related_files.docx"
...
def main() -> None:
    dashboard_module = sorted((ROOT / "app" / "dashboard").glob("*.py"))
    dashboard_templates = sorted((ROOT / "app" / "templates" / "includes" / "dashboard").glob("*.html"))
    ...
    categories: list[tuple[str, list[Path], str]] = [
        ...
        (
            ...
            resolve(
                [
                    "app/services/executive_brief.py",
                    "app/services/shared/dashboard_charts.py",
                    "app/services/shared/dashboard_charts_kpi.py",
                    "app/services/shared/dashboard_charts_trends.py",
                ]
            ),
            text(
                r"\u041e\u0431\u0449\u0438\u0435 \u043c\u043e\u0434\u0443\u043b\u0438, ",
        ...
        (
            ...
            resolve(
                [
                    ...
                    "app/templates/includes/common_intro_macros.html",
        ...
        (
            ...
            resolve(
                [
                    ...
                    "app/static/js/dashboard_events.js",
                    "app/static/js/dashboard_render.js",
                    "app/static/js/dashboard_state.js",
        ...
        (
            ...
            resolve(
                [
                    "tests/analytics_api_contract_dashboard_cases.py",
                    "tests/dashboard_analytics_test_helpers.py",
                    "tests/test_dashboard_damage.py",
                    "tests/test_dashboard_distribution.py",
                    "tests/test_dashboard_impact.py",
                    "tests/test_dashboard_service_cache.py",
                    "tests/test_dashboard_summary_management.py",
                ]
            ),
            text(
                r"\u0424\u0430\u0439\u043b\u044b \u0442\u0435\u0441\u0442\u043e\u0432, ",
    ...
    add_paragraph(
        ...
        text(
            ...
            r"\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443 \u043f\u0430\u043d\u0435\u043b\u0438, ",
            r"\u0435\u0435 API, \u0448\u0430\u0431\u043b\u043e\u043d\u044b, ",
            r"\u0441\u0442\u0438\u043b\u0438, JavaScript, \u0431\u0438\u0437\u043d\u0435\u0441-\u043b\u043e\u0433\u0438\u043a\u0443 ",
            r"\u0438 \u043f\u0440\u043e\u0444\u0438\u043b\u044c\u043d\u044b\u0435 \u0442\u0435\u0441\u0442\u044b. ",
            r"\u041e\u0431\u0449\u0435\u0441\u0438\u0441\u0442\u0435\u043c\u043d\u044b\u0435 ",
            r"\u0444\u0430\u0439\u043b\u044b \u0431\u0435\u0437 \u043f\u0440\u044f\u043c\u043e\u0439 ",
            r"\u0441\u0432\u044f\u0437\u0438 \u0441 \u0431\u043b\u043e\u043a\u043e\u043c ",
            r"\u043d\u0435 \u0432\u043a\u043b\u044e\u0447\u0430\u043b\u0438\u0441\u044c.",
