...
OUTPUT_PATH = ROOT / "documents" / "clustering_related_files.docx"
...
def main() -> None:
    clustering_module = sorted((ROOT / "app" / "services" / "clustering").glob("*.py"))
    clustering_templates = sorted((ROOT / "app" / "templates" / "includes" / "clustering").glob("*.html"))
    ...
    categories: list[tuple[str, list[Path], str]] = [
        ...
        (
            text(r"\u041c\u043e\u0434\u0443\u043b\u044c \u043a\u043b\u0430\u0441\u0442\u0435\u0440\u0438\u0437\u0430\u0446\u0438\u0438"),
            clustering_module,
            text(
                r"\u041e\u0441\u043d\u043e\u0432\u043d\u0430\u044f ",
                r"\u0441\u0435\u0440\u0432\u0438\u0441\u043d\u0430\u044f \u043b\u043e\u0433\u0438\u043a\u0430 ",
                r"\u0431\u043b\u043e\u043a\u0430 \u043a\u043b\u0430\u0441\u0442\u0435\u0440\u0438\u0437\u0430\u0446\u0438\u0438: ",
                r"\u0430\u0433\u0440\u0435\u0433\u0430\u0446\u0438\u044f \u043f\u0440\u0438\u0437\u043d\u0430\u043a\u043e\u0432, ",
                r"\u0430\u043b\u0433\u043e\u0440\u0438\u0442\u043c\u044b clustering, ",
                r"\u043a\u0430\u0447\u0435\u0441\u0442\u0432\u043e \u0440\u0430\u0437\u0431\u0438\u0435\u043d\u0438\u044f, ",
                r"\u0441\u0431\u043e\u0440\u043a\u0430 \u0434\u0438\u0430\u0433\u043d\u043e\u0441\u0442\u0438\u043a\u0438, ",
                r"\u0434\u0436\u043e\u0431\u044b \u0438 \u0442\u0438\u043f\u044b.",
            ),
        ),
        (
            ...
            text(
                ...
                r"\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u043a\u043b\u0430\u0441\u0442\u0435\u0440\u0438\u0437\u0430\u0446\u0438\u0438, ",
                r"\u0432\u043a\u043b\u044e\u0447\u0430\u044f hero-\u0431\u043b\u043e\u043a, ",
                r"\u043f\u0430\u043d\u0435\u043b\u044c \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u043e\u0432, ",
                r"\u043e\u0431\u0437\u043e\u0440 \u043a\u0430\u0447\u0435\u0441\u0442\u0432\u0430 ",
                r"\u0438 \u0430\u043d\u0430\u043b\u0438\u0437 \u043a\u043b\u0430\u0441\u0442\u0435\u0440\u043e\u0432.",
            ),
        ),
        (
            ...
            resolve(
                [
                    ...
                    "app/static/css/clustering.css",
                    "app/static/js/sidebar.js",
                    "app/static/js/analytics_shared.js",
                    "app/static/js/clustering.js",
                    "app/static/js/clustering_events.js",
                    "app/static/js/clustering_render.js",
                    "app/static/js/clustering_state.js",
        ...
        (
            ...
            resolve(
                [
                    "tests/clustering_math_analysis_cases.py",
                    "tests/clustering_math_quality_cases.py",
                    "tests/test_clustering_math.py",
                ]
            ),
            text(
                r"\u0424\u0430\u0439\u043b\u044b \u0442\u0435\u0441\u0442\u043e\u0432, ",
                ...
                r"\u043c\u0430\u0442\u0435\u043c\u0430\u0442\u0438\u043a\u0443 ",
                r"\u043a\u043b\u0430\u0441\u0442\u0435\u0440\u043d\u043e\u0433\u043e \u0430\u043d\u0430\u043b\u0438\u0437\u0430 ",
                r"\u0438 \u043c\u0435\u0442\u0440\u0438\u043a\u0438 \u043a\u0430\u0447\u0435\u0441\u0442\u0432\u0430.",
            ),
        ),
    ]
    ...
    add_paragraph(
        ...
        text(
            ...
            r"\u043f\u0440\u044f\u043c\u044b\u0435 \u0444\u0430\u0439\u043b\u044b, ",
            r"\u043e\u043f\u0440\u0435\u0434\u0435\u043b\u044f\u044e\u0449\u0438\u0435 ",
            r"\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443 \u043a\u043b\u0430\u0441\u0442\u0435\u0440\u0438\u0437\u0430\u0446\u0438\u0438, ",
            r"\u0435\u0435 API, \u0448\u0430\u0431\u043b\u043e\u043d\u044b, ",
            r"\u0441\u0442\u0438\u043b\u0438, JavaScript, \u0441\u0435\u0440\u0432\u0438\u0441\u043d\u0443\u044e ",
            r"\u043b\u043e\u0433\u0438\u043a\u0443 \u0430\u0433\u0440\u0435\u0433\u0430\u0446\u0438\u0438 ",
            r"\u043f\u0440\u0438\u0437\u043d\u0430\u043a\u043e\u0432, clustering-\u0430\u043b\u0433\u043e\u0440\u0438\u0442\u043c\u0430 ",
            r"\u0438 \u043e\u0446\u0435\u043d\u043a\u0438 \u043a\u0430\u0447\u0435\u0441\u0442\u0432\u0430 ",
            r"\u0441\u0435\u0433\u043c\u0435\u043d\u0442\u0430\u0446\u0438\u0438. ",
            r"\u041e\u0431\u0449\u0435\u0441\u0438\u0441\u0442\u0435\u043c\u043d\u044b\u0435 ",
            r"\u0444\u0430\u0439\u043b\u044b \u0431\u0435\u0437 \u043f\u0440\u044f\u043c\u043e\u0439 ",
