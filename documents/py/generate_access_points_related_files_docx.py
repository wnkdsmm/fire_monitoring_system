...
OUTPUT_PATH = ROOT / "documents" / "access_points_related_files.docx"
...
def main() -> None:
    access_points_module = sorted((ROOT / "app" / "services" / "access_points").glob("*.py"))
    access_points_templates = sorted((ROOT / "app" / "templates" / "includes" / "access_points").glob("*.html"))
    ...
    categories: list[tuple[str, list[Path], str]] = [
        (
            ...
            text(
                r"\u0424\u0430\u0439\u043b\u044b, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 ",
                r"\u043e\u0442\u0432\u0435\u0447\u0430\u044e\u0442 \u0437\u0430 URL ",
                r"\u0440\u0430\u0437\u0434\u0435\u043b\u0430 \u00ab\u041f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0435 ",
                r"\u0442\u043e\u0447\u043a\u0438\u00bb, \u0432\u044b\u0434\u0430\u0447\u0443 ",
                r"\u043a\u043e\u043d\u0442\u0435\u043a\u0441\u0442\u0430 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b ",
                r"\u0438 API \u043f\u0435\u0440\u0435\u0441\u0447\u0435\u0442\u0430 ",
                r"\u0440\u0435\u0439\u0442\u0438\u043d\u0433\u0430.",
            ),
        ),
        (
            ...
            text(
                r"\u041e\u0441\u043d\u043e\u0432\u043d\u0430\u044f ",
                r"\u0441\u0435\u0440\u0432\u0438\u0441\u043d\u0430\u044f \u043b\u043e\u0433\u0438\u043a\u0430 ",
                r"\u0431\u043b\u043e\u043a\u0430 access_points: ",
                r"\u0441\u0431\u043e\u0440 \u0434\u0430\u043d\u043d\u044b\u0445 \u043f\u043e ",
                r"\u0442\u043e\u0447\u043a\u0430\u043c, \u0432\u044b\u0431\u043e\u0440 ",
                r"\u0444\u0430\u043a\u0442\u043e\u0440\u043e\u0432, \u0440\u0430\u043d\u0436\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435, ",
                r"\u0444\u043e\u0440\u043c\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 ",
                r"\u043f\u043e\u044f\u0441\u043d\u0435\u043d\u0438\u0439, \u043f\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u043b\u0435\u043d\u0438\u0435 ",
                r"\u0440\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442\u043e\u0432 \u0438 \u0442\u0438\u043f\u044b.",
            ),
        ),
        (
            text(
            ...
            resolve(
                [
                    ...
                    "app/templates/access_points.html",
                    "app/templates/includes/sidebar_nav.html",
                ]
            )
            + access_points_templates,
            text(
                r"\u0428\u0430\u0431\u043b\u043e\u043d\u044b, \u0438\u0437 ",
                r"\u043a\u043e\u0442\u043e\u0440\u044b\u0445 \u0441\u043e\u0431\u0438\u0440\u0430\u0435\u0442\u0441\u044f ",
                r"\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u0440\u0430\u043d\u0436\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f ",
                r"\u043f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0445 \u0442\u043e\u0447\u0435\u043a, ",
                r"\u0432\u043a\u043b\u044e\u0447\u0430\u044f hero-\u0431\u043b\u043e\u043a, ",
                r"\u0444\u0438\u043b\u044c\u0442\u0440\u044b, \u0430\u043d\u0430\u043b\u0438\u0437 ",
                r"\u0438 \u0441\u0435\u043a\u0446\u0438\u0438 \u0440\u0435\u0439\u0442\u0438\u043d\u0433\u0430.",
        ...
        (
            ...
            resolve(
                [
                    ...
                    "app/static/css/access_points.css",
                    "app/static/js/sidebar.js",
                    "app/static/js/analytics_shared.js",
                    "app/static/js/access_points.js",
                    "app/static/js/access_points_events.js",
                    "app/static/js/access_points_render.js",
                    "app/static/js/access_points_state.js",
            ...
            text(
                ...
                r"\u0434\u043b\u044f \u043e\u0442\u0440\u0438\u0441\u043e\u0432\u043a\u0438 ",
                r"\u0440\u0435\u0439\u0442\u0438\u043d\u0433\u0430, \u0438\u043d\u0442\u0435\u0440\u0430\u043a\u0442\u0438\u0432\u043d\u044b\u0445 ",
                r"\u0444\u0438\u043b\u044c\u0442\u0440\u043e\u0432 \u0438 ",
                r"\u0432\u0438\u0437\u0443\u0430\u043b\u044c\u043d\u043e\u0433\u043e \u043f\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u043b\u0435\u043d\u0438\u044f ",
                r"\u043f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0445 \u0442\u043e\u0447\u0435\u043a.",
            ),
        ),
        (
            text(
                r"\u0422\u0435\u0441\u0442\u044b, \u043e\u0442\u043d\u043e\u0441\u044f\u0449\u0438\u0435\u0441\u044f ",
                r"\u043a \u0431\u043b\u043e\u043a\u0443 \u00ab\u041f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0435 ",
                r"\u0442\u043e\u0447\u043a\u0438\u00bb",
            ),
            resolve(
                [
                    "tests/access_points_point_cases.py",
                    "tests/access_points_ranking_cases.py",
                    "tests/access_points_scoring_support.py",
                    "tests/test_access_points_point_data.py",
                    "tests/test_access_points_score_context.py",
                    "tests/test_access_points_scoring.py",
                    "tests/test_access_points_shell_context.py",
    ...
    add_paragraph(
        ...
        text(
            ...
            r"\u043f\u0440\u044f\u043c\u044b\u0435 \u0444\u0430\u0439\u043b\u044b, ",
            r"\u043e\u043f\u0440\u0435\u0434\u0435\u043b\u044f\u044e\u0449\u0438\u0435 ",
            r"\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443 \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0445 ",
            r"\u0442\u043e\u0447\u0435\u043a, \u0435\u0435 API, \u0448\u0430\u0431\u043b\u043e\u043d\u044b, ",
            r"\u0441\u0442\u0438\u043b\u0438, JavaScript \u0438 ",
            r"\u0441\u0435\u0440\u0432\u0438\u0441\u043d\u0443\u044e \u043b\u043e\u0433\u0438\u043a\u0443 ",
            r"\u0440\u0430\u0441\u0447\u0435\u0442\u0430 \u0438 \u0440\u0430\u043d\u0436\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f ",
            r"\u043f\u0440\u043e\u0431\u043b\u0435\u043c\u043d\u044b\u0445 \u0442\u043e\u0447\u0435\u043a. ",
            r"\u041e\u0431\u0449\u0435\u0441\u0438\u0441\u0442\u0435\u043c\u043d\u044b\u0435 ",
            r"\u0444\u0430\u0439\u043b\u044b \u0431\u0435\u0437 \u043f\u0440\u044f\u043c\u043e\u0439 ",
            r"\u0441\u0432\u044f\u0437\u0438 \u0441 \u0431\u043b\u043e\u043a\u043e\u043c ",
